...
/// <param name="NetworkDate">
/// Дата в сети, записанная в тексте поставки («_в рознице с 15.10»). Она встаёт в «Дату в сети»
/// вместо формулы и выделяется в тексте красным. null - даты в тексте нет, дату считает формула.
/// </param>
