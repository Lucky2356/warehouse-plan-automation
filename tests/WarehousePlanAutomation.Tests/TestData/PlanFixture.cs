...
{
    public const long ExistingUrgentLoadNumber = 44575395;
    public const long ExistingSetLoadNumber = 44591671;
    public const long ExistingMonoLoadNumber = 44591776;
    public const long ExistingReturnLoadNumber = 44553189;
    public const long ExistingStorageLoadNumber = 44377185;
    public const string PlaceholderSupplies = "2421-051 Шапки_отгрузка по готовности";
    ...
    public static SheetGrid BuildGrid()
    {
        var rows = new List<object?[]>
        {
            ...
            DataRow(3, "Срочная подтоварка 28.08_Хранение, хранилище",
                ...
                networkDate: 46273),
            DataRow(4, "2430-026, 028 Обувь СЕТ1_в рознице с 1.10",
                loadNumber: ExistingSetLoadNumber, quantity: 576, percent: 0, networkDate: 46296),
            DataRow(5, "2430-026, 028 Обувь МОНО_в рознице с 1.10",
    ...
    public static PlanLayout BuildLayoutWithGapInAllGroups()
    {
        var rows = new List<object?[]>
        {
            ...
            DataRow(2, "Автозаказы для ХАБов", quantity: 42000),
            new object?[17],
            DataRow(3, "2430-026, 028 Обувь МОНО_в рознице с 1.10",
                loadNumber: ExistingMonoLoadNumber, quantity: 324, percent: 0, networkDate: 46296),
            DataRow(4, "2430-026, 028 Обувь СЕТ1_в рознице с 1.10",
                loadNumber: ExistingSetLoadNumber, quantity: 576, percent: 0, networkDate: 46296),
            Section("возвраты"),
