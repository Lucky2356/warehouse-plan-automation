...
{
    private const long LoadNumber = 44388195;
    ...
    private static JournalRow Doc(
        ...
        new(
            order,
            order + 2,
            "352-132, 357-041 ШПП_отгрузка по готовности Номер загрузки " + LoadNumber,
            status,
    ...
    public void НетЗаписиВЖурнале_ЗаказНеНайден()
    {
        var journal = new[]
        {
            new JournalRow(0, 2, "Другой заказ Номер загрузки 44377185", "ЗАКРЫТ", 100, "З000-1", 10, 10),
        };
    ...
    public void ПроцентСчитаетсяПоСуммамКоличестваИФакта()
    {
        ...
        var journal = new[]
        {
            Doc(0, "З000-760355", 8046, 8046, "ЗАКРЫТ"),
            Doc(1, "З000-760437", 15427, 2308),
        };
    ...
    public void СводныеСтрокиВРасчётНеПопадают()
    {
        ...
        {
            Summary(0, 8046, 8046),
            Doc(1, "З000-760355", 8046, 8046, "ЗАКРЫТ"),
            Doc(2, "З000-760437", 15427, 2308),
        };
    ...
    public void ПовторыОдногоДокументаСчитаютсяОдинРаз()
    {
        ...
        var journal = new[]
        {
            Doc(0, "З000-760355", 8046, 8046, "ЗАКРЫТ"),
            Doc(1, "З000-760355", 8046, 8046, "ЗАКРЫТ"),
            Doc(2, "З000-760355", 8046, 8046, "ЗАКРЫТ"),
            Doc(3, "З000-760437", 15427, 2308),
        };
    ...
    {
        // «44388195» не должно совпадать с «155388195» и «553881950»:
